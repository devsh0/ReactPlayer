...
export default function Player() {
  ...
  useEffect(() => {
    ...
    state.audioStreamNode =
      state.audioContext.createMediaElementSource(audioEl);
    ...
    function loadMedia() {
      ...
      const preloadMediaUrls = ["./senorita.ogg", "./maria.ogg"];
  ...
  function handleMediaResourceLoaded(mediaResources) {
    for (const media of mediaResources) playerState.session.enqueueMedia(media);
  }
